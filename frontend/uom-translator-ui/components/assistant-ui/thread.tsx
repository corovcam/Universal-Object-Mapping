...
import { RequestTimer } from "@/components/assistant-ui/timer";
...
const ThinkingIndicator: FC = () => {
	...
	return (
		<div className="flex items-center gap-2 px-2 py-4 text-muted-foreground animate-pulse">
			...
			>
				<div className="mx-auto flex w-full max-w-(--thread-max-width) flex-1 flex-col px-4 pt-4">
					...
					<ThreadPrimitive.ViewportFooter className="aui-thread-viewport-footer sticky bottom-0 mt-auto flex flex-col gap-2 overflow-visible rounded-t-(--composer-radius) bg-background pb-4 md:pb-6">
						...
						<div className="flex justify-end w-full px-2 -mb-2 z-10 pointer-events-none">
							<RequestTimer />
						</div>
						<Composer />
