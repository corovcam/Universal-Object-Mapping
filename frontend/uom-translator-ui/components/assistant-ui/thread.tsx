      ...
      <div className="aui-thread-welcome-center flex w-full grow flex-col items-center justify-center">
        <div className="aui-thread-welcome-message flex size-full flex-col justify-center px-4">
          <h1 className="aui-thread-welcome-message-inner fade-in slide-in-from-bottom-1 animate-in fill-mode-both font-semibold text-2xl duration-200">
            Welcome to <span className="font-bold bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent">Universal Object Mapping</span> Assistant!
          </h1>
...
const ReasoningGroupWrapper: FC<{ running: boolean; children: React.ReactNode }> = ({
  running,
  children,
}) => {
  ...
  return (
    <ReasoningRoot defaultOpen={running}>
      <ReasoningTrigger active={running} duration={elapsed > 0 ? elapsed : undefined} />
