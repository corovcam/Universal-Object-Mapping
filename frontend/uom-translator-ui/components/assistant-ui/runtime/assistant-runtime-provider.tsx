...
import { AssistantRuntimeProvider, Suggestions, useAui, type RemoteThreadListAdapter } from "@assistant-ui/react";
...
const ASSISTANT_ID =
  process.env.NEXT_PUBLIC_LANGGRAPH_ASSISTANT_ID || "universal-object-mapping-translator";
...
export function AssistantRuntimeProviderWrapper({ inputSuggestions, children }: { inputSuggestions: any, children: React.ReactNode }) {
  ...
  const runtime = useLangGraphRuntime({
    ...
    load: async (externalId, config) => {
      try {
        ...
        }>(externalId, undefined, config?.signal ? { signal: config.signal } : undefined);
        return {
