...
export default function Home() {
  ...
  try {
    efcoreToMongoInput = fs.readFileSync(cwd + '/app/data/input-efcore-mongodb.txt', 'utf-8');
    efcoreToNeo4jInput = fs.readFileSync(cwd + '/app/data/input-efcore-neo4j.txt', 'utf-8');
    dapperToMongoInput = fs.readFileSync(cwd + '/app/data/input-dapper-mongodb.txt', 'utf-8');
    nhibernateToMongoInput = fs.readFileSync(cwd + '/app/data/input-nhibernate-mongodb.txt', 'utf-8');
  } catch (error) {
    console.error(error);
  }
