...
async def run_one(fixture_text: str, single_pass: bool, model, approach: str, fixture: str) -> dict:
...
async def main_async(args: argparse.Namespace) -> None:
    ...
    for approach in args.approaches:
        ...
        r = await run_one(fixture_text, single_pass, model, approach, args.fixture)
