...
class OrderLine {
    ...
    @Relationship(type = "PEOPLE", direction = Relationship.Direction.OUTGOING)
    ...
    public Person getLastEditedBy() { return lastEditedBy; }
    public void setLastEditedBy(Person lastEditedBy) { this.lastEditedBy = lastEditedBy; }
}
