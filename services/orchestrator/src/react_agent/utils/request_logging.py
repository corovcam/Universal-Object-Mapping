...
class LoggingCallbackHandler(BaseCallbackHandler):
    ...
    def __init__(
        self, logs_dir: str = LOGS_DIR, log_string_max_length: int = 1000
    ) -> None:
        ...
        handler = logging.FileHandler(
            f"{logs_dir}/{self.timestamp}/langgraph_logging_{self.timestamp}.log"
        )
    ...
    def on_llm_start(
        ...
        self.logger.debug(
            "LLM start",
            extra={"payload": {"serialized": serialized, "prompts": prompts}, "kwargs": kwargs},
        )
    ...
    def on_chat_model_start(
        ...
        **kwargs: Any,
        ...
        self.logger.debug(
            "Chat model start",
            extra={"payload": {"serialized": serialized, "messages": messages}, "kwargs": kwargs},
        )
    ...
    def on_llm_end(self, response: LLMResult, **kwargs: Any) -> None:
        ...
        self.logger.debug(
            "LLM end", extra={"payload": {"response": response_dump}, "kwargs": kwargs}
        )
    ...
    def on_llm_error(self, error: BaseException, **kwargs: Any) -> None:
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments.
        """
        self.logger.debug("LLM error.", exc_info=error, extra={"payload": {"error": error}, "kwargs": kwargs})
        # out = self.out.get(kwargs.get("run_id", "default"))
        # if out and not out.closed:
        #     out.close()
    ...
    def on_chain_start(
        ...
        self.logger.debug(
            "Chain start",
            extra={"payload": {"serialized": serialized, "inputs": inputs}, "kwargs": kwargs},
        )
    ...
    def on_chain_end(self, outputs: dict[str, Any], **kwargs: Any) -> None:
        ...
        #         value = (
        #             value
        #             if len(value) <= self.log_string_max_length
        #             else f"{value[: self.log_string_max_length]}... [truncated]"
        #         )
        #         outputs_copy[key] = value
        self.logger.debug("Chain end", extra={"payload": {"outputs": outputs}, "kwargs": kwargs})
    ...
    def on_chain_error(self, error: BaseException, **kwargs: Any) -> None:
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments.
        """
        self.logger.debug("Chain error.", extra={"payload": {"error": error}, "kwargs": kwargs})
        # for out in self.out.values():
        #     if not out.closed:
        #         out.close()
    ...
    def on_tool_start(
        ...
        self.logger.debug(
            "Tool start",
            extra={"payload": {"serialized": serialized, "input_str": input_str}, "kwargs": kwargs},
        )
    ...
    def on_agent_action(self, action: AgentAction, **kwargs: Any) -> Any:
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments.
        """
        self.logger.debug("Agent action", extra={"payload": {"action": action}, "kwargs": kwargs})
    ...
    def on_tool_end(self, output: Any, **kwargs: Any) -> None:
        ...
        #         output_copy = (
        #             output_copy
        #             if len(output_copy) <= self.log_string_max_length
        #             else f"{output_copy[: self.log_string_max_length]}... [truncated]"
        #         )
        ...
        #                     else f"{value[: self.log_string_max_length]}... [truncated]"
        #                 )
        #                 output_copy[key] = value
        #     else:
        #         output_copy = f"Output of type {type(output)} is not logged in detail."
        # except Exception:
        #     output_copy = f"Output of type {type(output)} could not be logged."
        self.logger.debug("Tool end", extra={"payload": {"output": output}, "kwargs": kwargs})
    ...
    def on_tool_error(self, error: BaseException, **kwargs: Any) -> None:
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments.
        """
        self.logger.debug("Tool error.", exc_info=error, extra={"payload": {"error": error}, "kwargs": kwargs})
    ...
    def on_text(self, text: str, **kwargs: Any) -> None:
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments.
        """
        self.logger.debug("Text", extra={"payload": {"text": text}, "kwargs": kwargs})
    ...
    def on_agent_finish(self, finish: AgentFinish, **kwargs: Any) -> None:
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments.
        """
        self.logger.debug("Agent finish", extra={"payload": {"finish": finish}, "kwargs": kwargs})
